...
void UpdateComboDelay1(struct tetWell *well, struct cursor_t *cursor, s32 combo);
void UpdateChainDelay1(struct tetWell *well, struct cursor_t *cursor, s32 chain);
void UpdateComboDelay2(struct tetWell *well, struct cursor_t *cursor, s32 combo);
