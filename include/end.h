...
void Draw2DGameOver(struct struct_gInfo_unk_00068 *dynamicp);
void Draw3DGameOver(struct struct_gInfo_unk_00068 *dynamicp);
void DrawGameOver(struct struct_gInfo_unk_00068 *dynamicp);
