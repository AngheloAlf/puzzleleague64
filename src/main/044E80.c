...
// TODO: REGION_PAL ?
                        ...
                        if (CheckPlayerPuzzleRound(4, 1) && CheckPlayerPuzzleRound(5, 1) &&
                            CheckPlayerPuzzleRound(5, 0x1F) && CheckPlayerPuzzleRound(5, 0x29) &&
                            CheckPlayerPuzzleRound(6, 1) && CheckPlayerPuzzleRound(6, 0x1F) &&
