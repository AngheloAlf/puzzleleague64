...
void Update2DIcon(tetWell *well, cursor_t *cursor, s32 num) {
    ...
    for (var_s5 = 0; var_s5 < 0xA; var_s5++) {
        ...
        if ((temp_s0->flag == -1) && (temp_s0->count < 0) && (temp_s0->type >= ICONTYPE_12)) {
            sp1C = -1;
            break;
        }
    }
        ...
        if (temp_s0->count < 0) {
            ...
            if (temp_s0->type == ICONTYPE_12) {
                ...
                if (sp1C == 0) {
                    ...
                    var_v0_2 = (temp_s0->to_y + 1) * 0x10;
                }
                var_a2 = temp_s2 - (var_v0_2 + 6);
                temp_s0->distance = temp_s2 - var_v0_2;
                ...
                var_a1 = temp_s3 + ((temp_s0->from_x * 0x12) + 0xD);
                var_a2 = temp_s2 - ((temp_s0->to_y * 0x10) + 6);
                Start2DIconSplash(well, var_a1, var_a2);
