...
#if VERSION_USA
s32 Init3DPuzzle(struct tetWell *well, struct cursor_t *cursor, u8 *ptr, s32 number) {                                                                                                                                 s32 i;                                                                                                                                                                                                             s32 count;                                                                                                                                                                                                         u32 val;                                                                                                                                                                                                           u32 packed;                                                                                                                                                                                                        u32 type;                                                                                                                                                                                                                                                                                                                                                                                                                             Init3DTetrisBlocks(well, 0);                                                                                                                                                                                       number--;                                                                                                                                                                                                                                                                                                                                                                                                                             for (i = 0; i < number; i++) {                                                                                                                                                                                         count = *ptr;                                                                                                                                                                                                      ptr += (count << 1) + 2;                                                                                                                                                                                       }                                                                                                                                                                                                                                                                                                                                                                                                                                     count = *ptr++;                                                                                                                                                                                                    if (count == 0) {                                                                                                                                                                                                      cursor->target[0] = 0;                                                                                                                                                                                             return 0;                                                                                                                                                                                                      }                                                                                                                                                                                                                                                                                                                                                                                                                                     val = *ptr;                                                                                                                                                                                                        cursor->target[0] = val;                                                                                                                                                                                           cursor->target[1] = val;                                                                                                                                                                                                                                                                                                                                                                                                              for (i = 0; i < count; i++) {                                                                                                                                                                                          ptr++;                                                                                                                                                                                                             packed = *ptr++;                                                                                                                                                                                                   type = packed >> 4;                                                                                                                                                                                                packed &= 0xF;                                                                                                                                                                                                     well->block[packed][*ptr].type = type;                                                                                                                                                                         }                                                                                                                                                                                                                                                                                                                                                                                                                                     return -1;                                                                                                                                                                                                     }    
#endif
