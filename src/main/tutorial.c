...
#if VERSION_USA
INCLUDE_ASM("asm/usa/nonmatchings/main/tutorial", func_80088298_usa);
#endif
...
#if VERSION_EUR
INCLUDE_ASM("asm/eur/nonmatchings/main/tutorial", func_80088648_eur);
#endif
...
#if VERSION_GER
INCLUDE_ASM("asm/ger/nonmatchings/main/tutorial", func_80086F28_ger);
#endif
