...
s32 menuInitUser(u32 arg0) {
    if (arg0 < ARRAY_COUNT(gTheGame.unk_9C48)) {
        ...
        temp_s0->unk_029 = 0;
        temp_s0->unk_02A = 0;
        bzero(&temp_s0->unk_02B, 6);
        bzero(&temp_s0->unk_034, 0x80);
        temp_s0->unk_0B4 = 0;
        temp_s0->unk_0B5 = 0;
        temp_s0->unk_0B6 = 0;
        bzero(&temp_s0->unk_0B7, 4);
        bzero(&temp_s0->unk_0BB, 7);
        bzero(&temp_s0->unk_0C2, 7);
        bzero(&temp_s0->unk_0C9, 4);
        bzero(&temp_s0->unk_0CD, 7);
        bzero(&temp_s0->unk_0D4, 7);
        temp_s0->unk_0DB = 0;
        temp_s0->unk_0DC = 0;
        temp_s0->unk_0DD = 0;
        temp_s0->unk_0DE = 0;
        ...
        temp_s0->unk_0E9 = 0;
        temp_s0->unk_0EB = 0;
        bzero(&temp_s0->unk_0F1, 8);
        bzero(&temp_s0->unk_0F9, 8);
        bzero(&temp_s0->unk_101, 8);
        bzero(&temp_s0->unk_109, 8);
        bzero(&temp_s0->unk_111, 8);
        bzero(&temp_s0->unk_119, 8);
        bzero(&temp_s0->unk_121, 0x672);
        bzero(&temp_s0->unk_7A2, 0x12);
        bzero(&temp_s0->unk_7B4, 6);
        temp_s0->unk_7B4.unk_0 = 3;
        temp_s0->unk_7A2.unk_0A = 3;
        temp_s0->unk_7B4.unk_2 = 3;
        temp_s0->unk_7A2.unk_0C = 3;
        temp_s0->unk_7B4.unk_4 = 3;
        temp_s0->unk_7A2.unk_0E = 3;
        return -1;
    }
...
#if VERSION_USA
INCLUDE_ASM("asm/usa/nonmatchings/main/menu", func_8001A7D0_usa);
#endif

#if VERSION_USA
INCLUDE_ASM("asm/usa/nonmatchings/main/menu", func_8001A854_usa);
#endif
...
#if VERSION_EUR
INCLUDE_ASM("asm/eur/nonmatchings/main/menu", func_8001A90C_eur);
#endif

#if VERSION_EUR
INCLUDE_ASM("asm/eur/nonmatchings/main/menu", func_8001A990_eur);
#endif
...
#if VERSION_FRA
INCLUDE_ASM("asm/fra/nonmatchings/main/menu", func_8001A940_fra);
#endif

#if VERSION_FRA
INCLUDE_ASM("asm/fra/nonmatchings/main/menu", func_8001A9C4_fra);
#endif
...
#if VERSION_GER
INCLUDE_ASM("asm/ger/nonmatchings/main/menu", func_8001A98C_ger);
#endif

#if VERSION_GER
INCLUDE_ASM("asm/ger/nonmatchings/main/menu", func_8001AA10_ger);
#endif
