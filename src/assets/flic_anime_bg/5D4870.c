...
static_assert(ARRAY_COUNT(flic_anime_bg_5D4870_0_texture) == TEX_0_WIDTH * TEX_0_HEIGHT,
...
static_assert(ARRAY_COUNT(flic_anime_bg_5D4870_1_texture) == TEX_1_WIDTH * TEX_1_HEIGHT,
              "The texture doesn't have the expected dimensions.");
